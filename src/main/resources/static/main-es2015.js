...
let AddModalComponent = class AddModalComponent {
    constructor(employeeService, dialogRef, dialog) {
    ...
    openMap() {
        const dialogRef = this.dialog.open(_map_modal_map_modal_component__WEBPACK_IMPORTED_MODULE_6__["MapModalComponent"], {
            autoFocus: false,
        ...
        dialogRef.afterClosed().subscribe(result => {
            if (result != undefined) {
                var ret = result;
                console.log(ret);
                this.location.patchValue(ret[0]);
                this.xCoord.patchValue(ret[1]);
                this.yCoord.patchValue(ret[2]);
            }
        });
    }
};
...
let UpdateModalComponent = class UpdateModalComponent {
    constructor(employeeService, dialogRef, data, dialog) {
        this.employeeService = employeeService;
        this.dialogRef = dialogRef;
        this.data = data;
        this.dialog = dialog;
    ...
    updateEmployee() {
        ...
        this.employeeService.updateEmployee(this.toUpdateEmployee.id, this.employee).subscribe(data => {
            console.log(data);
