...
let AddModalComponent = class AddModalComponent {
    constructor(employeeService, workplaceService, dialogRef, dialog) {
    ...
    ngOnInit() {
        this.initForm();
        this.workplaceService.getWorkplacesList().subscribe(data => {
            this.workplaces = data;
            this.initLocationGroups();
            this.locationGroupOptions = this.locationGroup.valueChanges
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["map"])(value => this.filterGroup(value)));
    ...
    initLocationGroups() {
        ...
        this.workplaces.forEach(workplace => {
            ...
            if (!groupExists) {
                this.locationGroups.push({ floor: workplace.floor, workplaces: [workplace] });
            }
        });
    }
    filterFn(list, value) {
        return list.filter(workplace => workplace.location.toLowerCase().includes(value.toLowerCase()));
    }
    filterGroup(value) {
        ...
        if (value) {
            ...
            return this.locationGroups
                .map(locationGroup => ({ floor: locationGroup.floor, workplaces: this.filterFn(locationGroup.workplaces, value) }))
                .filter(locationGroup => locationGroup.workplaces.length > 0);
        }
    ...
    addEmployee() {
        ...
        this.employeeService.addEmployee(this.employeePayload).subscribe(data => {
            console.log(data);
...
let LoginModalComponent = class LoginModalComponent {
    constructor(authService, tokenStorage, router, dialogRef, dialog) {
...
let ProfileComponent = class ProfileComponent {
    constructor(dialogRef, data, dialog, snackBar) {
        this.dialogRef = dialogRef;
        this.data = data;
        this.dialog = dialog;
    ...
    openMap() {
        const dialogRef = this.dialog.open(src_app_map_modal_map_modal_component__WEBPACK_IMPORTED_MODULE_3__["MapModalComponent"], {
    ...
    openUpdate() {
        this.dialogRef.close();
        const dialogRef = this.dialog.open(src_app_update_modal_update_modal_component__WEBPACK_IMPORTED_MODULE_4__["UpdateModalComponent"], {
            minWidth: '30vw',
            minHeight: '30vh',
        ...
        dialogRef.afterClosed().subscribe(result => {
            if (result) {
                ...
                this.openSnackBar("Employee successfully updated", "Close");
            }
        });
    }
...
ConfirmDeleteModalComponent.ctorParameters = () => [
...
let EmployeeListComponent = class EmployeeListComponent {
    ...
    initEmployeesList() {
        this.employeeService.getEmployeesList().subscribe(data => {
            ...
            this.dataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_2__["MatTableDataSource"](this.employeesList);
    ...
    openDeleteConfirm() {
        const dialogRef = this.dialog.open(_confirm_delete_modal_confirm_delete_modal_component__WEBPACK_IMPORTED_MODULE_9__["ConfirmDeleteModalComponent"], {
            position: { top: '10%' },
            autoFocus: false,
    ...
    setToUpdateEmployee(id) {
        this.employeeService.getEmployee(id).subscribe(data => {
            //console.log(data);
            this.openUpdate(data);
        }, error => console.log(error));
    }
    openUpdate(data) {
        const dialogRef = this.dialog.open(_update_modal_update_modal_component__WEBPACK_IMPORTED_MODULE_10__["UpdateModalComponent"], {
            minWidth: '30vw',
            minHeight: '30vh',
            data: { employee: data }
        });
    ...
    openMap(workplace) {
        const dialogRef = this.dialog.open(_map_modal_map_modal_component__WEBPACK_IMPORTED_MODULE_11__["MapModalComponent"], {
    ...
    openProfile() {
        const dialogRef = this.dialog.open(_authentication_profile_profile_component__WEBPACK_IMPORTED_MODULE_13__["ProfileComponent"], {
            autoFocus: false,
...
let EmployeeService = class EmployeeService {
    ...
    updateEmployee(id, employeePayload) {
...
let UpdateModalComponent = class UpdateModalComponent {
    constructor(employeeService, dialogRef, data, dialog, workplaceService) {
        this.employeeService = employeeService;
        this.dialogRef = dialogRef;
        this.data = data;
        this.dialog = dialog;
    ...
    updateEmployee() {
        ...
        console.log(this.employeePayload);
        this.employeeService.updateEmployee(this.toUpdateEmployee.id, this.employeePayload).subscribe(data => {
            console.log(data);
...
UpdateModalComponent.ctorParameters = () => [
    { type: _employee_service__WEBPACK_IMPORTED_MODULE_4__["EmployeeService"] },
    { type: _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatDialogRef"] },
...
WorkplaceService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
